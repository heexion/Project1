...
////프로그램에서 같은 유형의 정보를 표현하고자 할 때 사용하며, enum 자체는 따로 뜻을 가지고 있진 않습니다.
////(분리와 종류 식별 목적)
//enum Genre {Balad, Trot, Dance, Rap, Rock,Indi };
//enum Category {KPOP, JPOP, POP};
//
//class Song
//{
//private : 
...
//int main()
//{
//	Song s("밤양갱","BIBI", Indi, KPOP); //생성자를 수정하면 클래스 생성 시 넣어줄 값을 전달해서 작업하기에
...
//}
//
//// ::은 ~에 있는 이라고 해석하면됨 Song에 있는 Song, Song에 있는 Songinfo
...
//	this->title = title; //this-> (디스포인터) : 클래스 자기 자신이 가지고 있는 값임을 명시하는 기능
